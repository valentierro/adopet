...
export const IN_APP_NOTIFICATION_TYPES = {
  ...
  /** Assinatura com pagamento pendente (past_due, unpaid). */
  PARTNERSHIP_PAYMENT_PAST_DUE: 'PARTNERSHIP_PAYMENT_PAST_DUE',
  /** Lembrete: parceria termina em 3 dias (cancelamento agendado). */
  PARTNERSHIP_CANCELLATION_REMINDER: 'PARTNERSHIP_CANCELLATION_REMINDER',
